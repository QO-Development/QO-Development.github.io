      ...
      <Navbar className="colorNav" expand="lg">
        ...
        <Navbar.Collapse className="collapser" id="basic-navbar-nav">
          <Nav className="linksContainer">
            ...
            <Nav.Link target="_blank" href="https://twitter.com/hawtcode">
              <img alt="twitter icon" src={twitterIcon}></img>
            </Nav.Link>
            <Nav.Link target="_blank" href="https://github.com/QO-Development">
              <img alt="github icon" src={githubIcon}></img>
            </Nav.Link>
            <Nav.Link
              target="_blank"
              href="https://www.linkedin.com/in/joshuahawthorne/"
            >
